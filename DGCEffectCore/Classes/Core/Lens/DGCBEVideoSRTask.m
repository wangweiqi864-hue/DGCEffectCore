...
@implementation DGCBEVideoSRTask
...
-(int) initTask{
    ...
    if (self.provider.licenseMode == OFFLINE_LICENSE) {
        ret = bef_ai_image_quality_enhancement_video_sr_check_license(_handle, [self.provider licensePath:BEF_VIDEO_SR]);
        ...
        ret = bef_ai_image_quality_enhancement_video_sr_check_online_license(_handle, [self.provider licensePath:BEF_VIDEO_SR]);
