//  DGCBEActionRecognitionAlgorithmTask.h
// EffectsARSDK
...
@interface DGCBEActionRecognitionAlgorithmResult : NSObject

@property (nonatomic, assign) bef_ai_action_recognition_result *actionRecognitionInfo;

@end

@interface DGCBEActionRecognitionAlgorithmTask : DGCBEAlgorithmTask
